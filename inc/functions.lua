...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(snfor..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(snfor..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(snfor..':Beso_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
elseif redis:sismember(snfor..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(snfor..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(snfor..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(snfor..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(snfor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(snfor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(snfor..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(snfor..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(snfor..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(snfor..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(snfor..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(snfor..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(snfor..':SUDO_BOT:')
message = '👨🏽‍💻*¦* قائمه الـمـطـوريـن : \n\n`👨‍✈️┇مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(snfor..'username:'..v)
local count = redis:scard(snfor..'mtwr_count'..v)
...
local monsha = redis:smembers(snfor..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n\n📋¦ قائمه المدراء :*\n\n'
local list = redis:smembers(snfor..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(snfor..'admins:'..msg.chat_id_)
...
local list = redis:smembers(snfor..'whitelist:'..msg.chat_id_)
...
if redis:sismember(snfor..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(snfor..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(snfor..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(snfor..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(snfor..'gban_users')
...
local list = redis:smembers(snfor..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(snfor..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*┇*الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(snfor..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(snfor..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(snfor..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(snfor..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(snfor..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(snfor..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(snfor..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local creator = redis:smembers(snfor..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local list = redis:smembers(snfor..'group:ids')
message = '📋*┇*قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(snfor..'group:name'..v)
if info then 
...
redis:del(
snfor..'group:add'..id_group,
snfor..'lock_link'..id_group, 
snfor..'lock_id'..id_group,
snfor..'lock_spam'..id_group, 
snfor..'lock_webpage'..id_group,
snfor..'lock_markdown'..id_group,
snfor..'lock_flood'..id_group,
snfor..'lock_bots'..id_group,
snfor..'mute_forward'..id_group,
snfor..'mute_contact'..id_group,
snfor..'mute_location'..id_group,
snfor..'mute_document'..id_group,
snfor..'mute_keyboard'..id_group,
snfor..'mute_game'..id_group,
snfor..'mute_inline'..id_group,
snfor..'lock_username'..id_group,
snfor..'num_msg_snfor'..id_group,
snfor..'replay'..id_group
)
redis:srem(snfor..'group:ids',id_group)
end
...
redis:hset(snfor..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(snfor..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(snfor..'group:add'..msg.chat_id_) then  return '🎗*┊*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
redis:setex(snfor..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(snfor..':addnumberusers') or 0)
...
local lock_service = redis:get(snfor..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(snfor..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(snfor..':Beso_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
snfor..'group:add'..msg.chat_id_,true,
snfor..'lock_link'..msg.chat_id_,true, 
snfor..'lock_id'..msg.chat_id_,true,
snfor..'lock_spam'..msg.chat_id_,true,
snfor..'lock_webpage'..msg.chat_id_,true,
snfor..'lock_markdown'..msg.chat_id_,true,
snfor..'lock_flood'..msg.chat_id_,true,
snfor..'lock_bots'..msg.chat_id_,true,
snfor..'mute_forward'..msg.chat_id_,true,
snfor..'mute_contact'..msg.chat_id_,true,
snfor..'mute_location'..msg.chat_id_,true,
snfor..'mute_document'..msg.chat_id_,true,
snfor..'mute_keyboard'..msg.chat_id_,true,
snfor..'mute_game'..msg.chat_id_,true,
snfor..'mute_inline'..msg.chat_id_,true,
snfor..'lock_username'..msg.chat_id_,true,
snfor..'num_msg_snfor'..msg.chat_id_,5, 
snfor..'replay'..msg.chat_id_,true
)

redis:sadd(snfor..'group:ids',msg.chat_id_) 
redis:sadd(snfor..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(snfor..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(snfor..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(snfor..'group:add'..msg.chat_id_) then return '🛠*┊* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(snfor..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID,'username',Resolv)
redis:sadd(snfor..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(snfor..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(snfor..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(snfor..':Beso_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID,'username',Resolv)
redis:sadd(snfor..':Beso_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remBeso" then
if not redis:sismember(snfor..':Beso_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(snfor..':Beso_BOT:'..ChatID,UserID)
...
if redis:sismember(snfor..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(snfor..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(snfor..'whitelist:'..ChatID,UserID)
...
if redis:sismember(snfor..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..'owners:'..ChatID,UserID)
...
if redis:sismember(snfor..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇ العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(snfor..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(snfor..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(snfor..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(snfor..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(snfor..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(snfor..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(snfor..'banned:'..ChatID,UserID)
...
if redis:sismember(snfor..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(snfor..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(snfor..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(snfor..'username:'..UserID, 'username',Resolv)
redis:sadd(snfor..'gban_users',UserID)
...
redis:srem(snfor..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(snfor..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(snfor..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(snfor..':SUDO_BOT:',UserID)
...
redis:hset(snfor..'username:'..UserID, 'username', UserName)
redis:sadd(snfor..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎟*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(snfor..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » ❪ '..UserName..' ❫\n🎫*┇*الايدي » ❪ `'..UserID..'` ❫\n💯*┇*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(snfor..'username:'..UserID, 'username', Resolv)
redis:sadd(snfor..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(snfor..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(snfor..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(snfor..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*┇*العضو » '..USERNAME..' \n🎫*┇* الايدي » (`'..UserID..'`)\n💯*┇*انه بالتأكيد ليس مطور \n✓') end
redis:srem(snfor..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂┇العضو » ❪ '..USERNAME..' ❫\n🎫┇الايدي » ❪ '..UserID..' ❫\n💯┇تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(snfor..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(snfor..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(snfor..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(snfor..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾*` اعدادات المجموعه :` \n"
.."\n📝╿التعديل «» "..(redis:get(snfor..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗│الروابط «» "..(redis:get(snfor..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣│التاك «» "..(redis:get(snfor..'lock_tag'..msg.chat_id_) or 'false')
.."\n🐞│المعرفات «» "..(redis:get(snfor..'lock_username'..msg.chat_id_) or 'false')
.."\n💱│التكرار «» "..(redis:get(snfor..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑│الكلايش «» "..(redis:get(snfor..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐│الويب «» "..(redis:get(snfor..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️│الماركدوان «» "..(redis:get(snfor..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻│بالطرد البوتات «» "..(redis:get(snfor..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖│البوتات «» "..(redis:get(snfor..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕│عدد التكرار «» "..(redis:get(snfor..'num_msg_snfor'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬│`اعدادات الوسائط :`\n"
.."\n*🎑│*المتحركه «» "..(redis:get(snfor..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭│الدردشه «» "..(redis:get(snfor..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️│الانلاين «» "..(redis:get(snfor..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮│الالعاب «» "..(redis:get(snfor..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞│الصور «» "..(redis:get(snfor..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥│الفيديو «» "..(redis:get(snfor..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙│البصمات «» "..(redis:get(snfor..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉│الصوت «» "..(redis:get(snfor..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎│الملصقات «» "..(redis:get(snfor..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞│الجهات «» "..(redis:get(snfor..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱│التوجيه «» "..(redis:get(snfor..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐│الموقع «» "..(redis:get(snfor..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂│الملفات «» "..(redis:get(snfor..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅│الاشعارات «» "..(redis:get(snfor..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒│الكيبورد «» "..(redis:get(snfor..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒│*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️│*الترحيب «» "..welcomex
.."\n*💬│*الردود «» "..replayx
...
.."\n*🌐│*الويب «» "..(redis:get(snfor..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚜️│*الماركدوان «» "..(redis:get(snfor..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*🏌🏻│*البوتات بالطرد «» "..(redis:get(snfor..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*🤖│*البوتات «» "..(redis:get(snfor..'lock_bots'..msg.chat_id_) or 'false')
.."\n*➕╽*عدد التكرار «» "..(redis:get(snfor..'num_msg_snfor'..msg.chat_id_) or 'false')
.."\n┄─┅═ـ═┅─┄\n*👨‍💻*اعدادات التقـييد :\n"
.."\n*💢╿*التقييد بالتوجيه «» "..(redis:get(snfor..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸│*التقييد بالصور «» "..(redis:get(snfor..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗│*التقييد بالروابط «» "..(redis:get(snfor..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉│*التقييد بالمتحركه «» "..(redis:get(snfor..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥╽*التقييد الفيديو «» "..(redis:get(snfor..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
