...
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(snfor..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(snfor..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(snfor..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
snfor..'num_msg_max'..msg.chat_id_,5, 
...
if redis:sismember(snfor..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂￤العضو » ❪ '..USERNAME..' ❫\n🎫￤الايدي » ❪ '..UserID..' ❫\n💯￤انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(snfor..'username:'..UserID,'username',Resolv)
redis:sadd(snfor..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂￤ العضو » ❪ '..USERNAME..' ❫\n🎫￤الايدي » ❪ '..UserID..' ❫\n💯￤تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(snfor..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂￤العضو » ❪ '..USERNAME..' ❫\n🎫￤الايدي » ❪ '..UserID..' ❫\n💯￤انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(snfor..':KARA_BOT:'..ChatID,UserID)
...
.."\n➕￤عدد التكرار «» "..(redis:get(snfor..'num_msg_max'..msg.chat_id_) or 'false')
