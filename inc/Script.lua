...
# ▄████████▀   ▀█   █▀    ███         ▀██████▀    ███    ███  Ch : SNFOR
                                                 ███    ███ 
┊SNFOR ‿ @SOURCESNFOR
تم تطوير وبرمجة السورس من قبل بيسو ┊
┊@Jll_il ‿ @SOURCESNFOR 
#-------------------------------------------------------------------
]]
...
bd = '👨‍🎓￤العضو ['..USERNAME..'](tg://user?id='..msg.sender_user_id_..') \n📌￤لأستخدام البوت عليك الاشتراك ب قناة السورس @SOURCESNFOR'
...
redis:set(snfor.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(snfor..'lock:join:'..msg.chat_id_,true)
...
redis:del(snfor..'lock:join:'..msg.chat_id_)
return "*👨‍🎓*￤* أهلا عزيزي *"..msg.TheRankCmd.."*\n📡*￤* تم فتح الدخول بالرابط \n✓*" 
end


local function isnfor(msg,MsgText)
if msg.type ~= 'pv' then
...
redis:setex(snfor..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(snfor..'CheckExpire::'..msg.chat_id_) then 
redis:set(snfor..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️￤تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️￤تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️￤في مجموعه  » »  '..redis:get(snfor..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
if MsgText[2] == '1' then
redis:setex(snfor..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(snfor..'CheckExpire::'..msg.chat_id_) then 
redis:set(snfor..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️￤تم تفعيل الاشتراك   👍🏿\n📆￤ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️￤تم تفعيل الاشتراك  👍🏿\n📆￤ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(snfor..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(snfor..'CheckExpire::'..msg.chat_id_) then 
redis:set(snfor..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(snfor..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(snfor..'CheckExpire::'..msg.chat_id_) then 
redis:set(snfor..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(snfor..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(snfor..'group:name'..msg.chat_id_) or '')
redis:set(snfor..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. snfor..'')
...
if not msg.Director and redis:get(snfor..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(snfor..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
if not MsgText[2] and msg.reply_id then
if redis:get(snfor..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(snfor..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(snfor..'admins:'..msg.chat_id_)
redis:del(snfor..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(snfor..'owners:'..msg.chat_id_)
redis:del(snfor..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(snfor..'whitelist:'..msg.chat_id_)
redis:del(snfor..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
if not redis:get(snfor..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(snfor..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(snfor..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "⚠️*┇*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
redis:setex(snfor..'linkGroup'..msg.sender_user_id_,300,true)
return '🔗￤عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(snfor..'linkGroup'..msg.chat_id_) then 
return "📡*￤* اوه 🙀 لا يوجد رابط ☹️\n🔖*￤*لانشاء رابط ارسل { `انشاء رابط` }\n📡" 
end
local GroupName = redis:get(snfor..'group:name'..msg.chat_id_)
local GroupLink = redis:get(snfor..'linkGroup'..msg.chat_id_)
...
local Text = "🔖￤رابـط الـمـجـمـوعه 💯\n🌿￤"..Flter_Markdown(redis:get(snfor..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(snfor..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
local Mn3Word = redis:scard(snfor..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*￤* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(snfor..':Filter_Word:'..msg.chat_id_)
...
redis:del(snfor..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
if not redis:get(snfor..'welcome:msg'..msg.chat_id_) then 
return "📡*￤* اوه ☢ هنالك خطأ 🚸\n⚠️￤عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(snfor..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
local NumMnsha = redis:scard(snfor..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⚠️￤عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(snfor..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
local NumMnsha = redis:scard(snfor..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "⚠️￤عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(snfor..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(snfor..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌￤لا يوجد مستخدمين محظورين  *" end
message = '📋*￤* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(snfor..'banned:'..msg.chat_id_)
return "👨‍🎓*￤*أهلا عزيزي "..msg.TheRankCmd.."   \n⚠️￤ تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
local MKTOMEN = redis:scard(snfor..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*￤* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(snfor..'is_silent_users:'..msg.chat_id_)
...
redis:del(snfor..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ} فقط  \n🎭" end
redis:setex(snfor..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(snfor..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ} فقط  \n🎭" end
redis:setex(snfor..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(snfor..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(snfor..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(snfor..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(snfor..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(snfor..'lock_id'..msg.chat_id_) then
local msgs = redis:get(snfor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(snfor..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(snfor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(snfor.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(snfor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(snfor..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(snfor..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(snfor..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(snfor..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(snfor..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(snfor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(snfor..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(snfor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "⚠️*￤*تم مسح {* "..msgs.." *} من رسائلك ☔️\n✓"
end

if MsgText[1]== 'جهاتي' then
return '🧟‍♂*￤*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*￤*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(snfor..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if nko == 0 then  return "⚠️*￤*عذرا ليس لديك مجوهرات لكي يتم مسحها" end
redis:del(snfor..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(snfor..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(snfor..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(snfor..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(snfor..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(snfor..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(snfor..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(snfor..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(snfor..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(snfor..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
redis:set(snfor..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
if redis:get(snfor..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(snfor..'welcome:msg'..msg.chat_id_))
else 
return "👨‍🎓*￤*أهلا عزيزي "..msg.TheRankCmd.."  \n🌿￤نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
local groups = redis:smembers(snfor..'group:ids')
...
local pv = redis:smembers(snfor..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(snfor..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(snfor..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜￤اهلا انآ بوت آسـمـي ]]..redis:get(snfor..':NameBot:')..[[ ✓
...
redis:setex(snfor..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭￤حسننا عزيزي 🍁\n💬￤الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(snfor..':addnumberusers',MsgText[2]) 
return '💱*￤* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*￤* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(snfor..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
return '📮*￤* عدد المجموعات المفعلة » `'..redis:scard(snfor..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
return '🙍🏻‍♂*￤*عدد المشتركين في البوت : `'..redis:scard(snfor..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
if redis:sismember(snfor..'group:ids',MsgText[2]) then
local name_gp = redis:get(snfor..'group:name'..MsgText[2])
...
return redis:get(snfor..":TEXT_SUDO") or '🗃￤لا توجد كليشه المطور .\n📰￤يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه ??" then
if not msg.SudoUser then return"⚠️*￤*هذا الامر يخص {المطور} فقط  \n🎭" end
if not msg.SudoBase and not redis:get(snfor..'lock_brod') then 
return "📡*￤* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(snfor..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(snfor..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(snfor..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(snfor..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
redis:del(snfor..'welcom:witting'..msg.sender_user_id_,
snfor..'rulse:witting'..msg.sender_user_id_,
snfor..'rulse:witting'..msg.sender_user_id_,
snfor..'name:witting'..msg.sender_user_id_,
snfor..'about:witting'..msg.sender_user_id_,
snfor..'fwd:all'..msg.sender_user_id_,
snfor..'fwd:pv'..msg.sender_user_id_,
snfor..'fwd:groups'..msg.sender_user_id_,
snfor..'namebot:witting'..msg.sender_user_id_,
snfor..'addrd_all:'..msg.sender_user_id_,
snfor..'delrd:'..msg.sender_user_id_,
snfor..'addrd:'..msg.sender_user_id_,
snfor..'delrdall:'..msg.sender_user_id_,
snfor..'text_sudo:witting'..msg.sender_user_id_,
snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_,
snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return '📬*￤* تم آلغآء آلآمـر بنجآح \n🌿'
end  


if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return '👨🏾‍🔧￤ اصدار سورس سنفور : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
local GetVerison = https.request('https://github.com/SOURCESNFOR/Tools/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*￤* يوجد تحديث جديد الان \n📡*￤* جاري تنزيل وتثبيت التحديث  ...')
redis:set(snfor..":VERSION",GetVerison)
return false
else
...
local inline = {{{text="⚜￤قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@SOURCESNFOR"}}}
send_key(msg.sender_user_id_,'  [⚜￤قناة سورس : سنفور](t.me/@SOURCESNFOR)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 🎭" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
return '🎭￤الاحصائيات 🏌‍♂ \n\n👥*￤*عدد المجموعات المفعله : '..redis:scard(snfor..'group:ids')..'\n🙍🏻‍♂*￤*عدد المشتركين في البوت : '..redis:scard(snfor..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
redis:setex(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(snfor..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "📭￤حسننا الان ارسل كلمة الرد العام 🍃\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
local names 	= redis:exists(snfor..'replay:'..msg.chat_id_)
local photo 	= redis:exists(snfor..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(snfor..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(snfor..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(snfor..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(snfor..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(snfor..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(snfor..'replay:'..msg.chat_id_,snfor..'replay_photo:group:'..msg.chat_id_,snfor..'replay_voice:group:'..msg.chat_id_,
snfor..'replay_animation:group:'..msg.chat_id_,snfor..'replay_audio:group:'..msg.chat_id_,snfor..'replay_sticker:group:'..msg.chat_id_,snfor..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(snfor..'replay:all')
local photo 	= redis:exists(snfor..'replay_photo:group:')
local voice 	= redis:exists(snfor..'replay_voice:group:')
local imation 	= redis:exists(snfor..'replay_animation:group:')
local audio 	= redis:exists(snfor..'replay_audio:group:')
local sticker 	= redis:exists(snfor..'replay_sticker:group:')
local video 	= redis:exists(snfor..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(snfor..'replay:all',snfor..'replay_photo:group:',snfor..'replay_voice:group:',snfor..'replay_animation:group:',snfor..'replay_audio:group:',snfor..'replay_sticker:group:',snfor..'replay_video:group:')
...
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
redis:set(snfor..'delrdall:'..msg.sender_user_id_,true) 
return "📭￤حسننا عزيزي  ✋🏿\n🗯￤الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
redis:set(snfor..'delrd:'..msg.sender_user_id_,true)
return "📭￤حسننا عزيزي  ✋🏿\n🗯￤الان ارسل الرد لمسحها من  للمجموعه 🍃"
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
local names  	= redis:hkeys(snfor..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(snfor..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(snfor..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(snfor..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(snfor..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(snfor..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(snfor..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(snfor..'replay:all')
local photo 	= redis:hkeys(snfor..'replay_photo:group:')
local voice 	= redis:hkeys(snfor..'replay_voice:group:')
local imation 	= redis:hkeys(snfor..'replay_animation:group:')
local audio 	= redis:hkeys(snfor..'replay_audio:group:')
local sticker 	= redis:hkeys(snfor..'replay_sticker:group:')
local video 	= redis:hkeys(snfor..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*￤*لا يوجد ردود مضافه حاليا \n🎭' 
end
local ii = 1
...
if not msg.Director then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🎭" end
redis:setex(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(snfor..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭￤حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
redis:setex(snfor..'namebot:witting'..msg.sender_user_id_,300,true)
...
⚀┤ م3← •⊱ آوآمر آݪحمايهـﮧ ⊰• 
⚁┤ م4← •⊱ آوآمر آݪخدميهـﮧ ⊰•
⚃┤ م5← •⊱ آوآمر آݪتعطيل و الوضع ⊰•
👨‍💻┤ م المطور ← •⊱ اوامر مطور الاساسي ⊰•
🌀┤ اوامر الرد ← •⊱ لاضافة رد معين ⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─ 
 ‏‎‏ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ { ]]..SUDO_USER..[[ } ✓ ]]
end
...
─ ─ ─ ─ ─ ─ ─ ─ ─
🗑￤مسح الادمنـيـه ‿ •⊱لمسح الادمنيه⊰•
🗑￤مسح المميزين ‿ •⊱لمسح المميزين⊰•
🗑￤مسح المــــدراء ‿ •⊱لمسح المدراء⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
...
🔊￤الغاء الكتم •⊱بالرد‿بالمعرف⊰•لالغاء الكتم 
🚷￤تقييد •⊱بالرد ‿ بالمعرف⊰• لتقييد العضو
🔓￤فك التقييد •⊱بالرد ‿ بالمعرف⊰• لالغاء تقييد العضو
🚫￤منع + الكلمه ‿ لمنع كلمه داخل المجموعه
⭕️￤الغاء منع ‿ لالغاء منع الكلمه
─ ─ ─ ─ ─ ─ ─ ─ ─
ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ↭ ]]..SUDO_USER
...
─ ─ ─ ─ ─ ─ ─ ─ ─
🔮￤الـرابـط ‿ لعرض •⊱الرابط⊰•  
🔗￤انشاء رابط ‿ لستخراج •⊱الرابط⊰•  
👨‍🔧￤الادمنيه ‿ لعرض •⊱الادمنيه⊰•
🧾￤القوانين ‿ لعرض •⊱القوانين⊰• 
🌄￤الوسائط ‿ لعرض اعدادات •⊱الميديا⊰• 
👨‍💻￤الحمايـه ‿ لعرض كل •⊱الاعدادات⊰•  
👷‍♂￤المــدراء ‿ لعرض •⊱الاداريين⊰• 
🤐￤المكتومين ‿ لعـرض •⊱المكتومين⊰• 
🥺￤المحظورين ‿ لعرض •⊱المحظورين⊰•
...
📵￤قفل ‿ فتح •⊱الكـــل⊰•
🙋‍♂￤قفل ‿ فتح •⊱التـاك⊰•
📽￤قفل ‿ فتح •⊱الفيـديـــو⊰•
🌄￤قفل ‿ فتح •⊱الصــــــــور⊰•
🚫￤قفل ‿ فتح •⊱الملصقات⊰•
🎭￤قفل ‿ فتح •⊱المتحركه⊰•
🔇￤قفل ‿ فتح •⊱البصمــات⊰•
🤐￤قفل ‿ فتح •⊱الدردشـــه⊰•
🖇￤قفل ‿ فتح •⊱الــروابـــط⊰•
🤖￤قفل ‿ فتح •⊱البـــوتــات⊰•
🖊￤قفل ‿ فتح •⊱التعــديــل⊰•
🎫￤قفل ‿ فتح •⊱المعرفــات⊰•
📝￤قفل ‿ فتح •⊱الكـــلايـش⊰•
♻️￤قفل ‿ فتح •⊱التـــكـــــرار⊰•
📞￤قفل ‿ فتح •⊱الجــهـــــات⊰•
🌐￤قفل ‿ فتح •⊱الانـــلايــن⊰•
🔚￤قفل ‿ فتح •⊱التوجيــــه⊰•
🚫￤قفل ‿ فتح •⊱الدخول بالرابط⊰•
🏌‍♂￤قفل ‿ فتح •⊱البوتات بالطرد⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─     
²║•⊱القفل بالتقييـد⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─                                                                                        
📸￤قفل ‿ فتح •⊱الــصــــــور بالتقييـد⊰•
🔗￤قفل ‿ فتح •⊱الــروابــط بالتقييـد⊰•
🎭￤قفل ‿ فتح •⊱المتحركه بالتقييـد⊰•
📽￤قفل ‿ فتح •⊱الفيـــديــو بالتقييد⊰•
🔒￤قفل ‿ فتح •⊱التوجيــه بالتقييــد⊰• 
─ ─ ─ ─ ─ ─ ─ ─ ─
ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
👨‍💻║•⊱اوامر الخدمــه⊰• 
─ ─ ─ ─ ─ ─ ─ ─ ─
😋￤اوامر التحشيش -:- لعرض قائمه التحشيش
🎟￤ايـــدي ‿ لعرض صورتك -:- معلوماتك
🎫￤ايديـي ‿ لعرض ايديك 
💳￤ايدي بالرد ‿ لعرض ايدي الشخص
🔗￤الرابط ‿ لستخراج رابط المجموعه
📞￤جهاتي ‿ لمعرفه عدد جهاتك
🕹￤الالعاب ‿ لعرض العاب البوت
😍￤بحث + اسم الاغنيه ‿ لبحث انواع الاغاني
💎￤مجوهراتي ‿ لمعرفه عدد مجوهراتك
💎￤بيع مجوهراتي -:- العدد ‿ لبيع مجوهراتك لتحصل على رسائل
💳￤معلوماتي ‿ لعرض معلوماتك
📟￤السورس ‿ لعرض سورس البوت
🎖￤الرتبه بالرد ‿ لمعرفه رتبه الشخص
📊￤التفاعل -:- بالمعرف ‿ لمعرفه تفاعل الشخص
📈￤التفاعل بالــرد ‿ لمعرفه تفاعل الشخص
💢￤كشف بالمعرف ‿ لمعرفه معلومات حسابه
👁‍🗨￤كشف بالرد ‿ لمعرفه معلومات حسابه
🤖￤كشف البوتات ‿ لاظهار عدد البوتات الموجوده بالمجموعه
🏌‍♂￤طرد البوتات ‿ لطرد كل البوتات
🏌‍♀￤طرد المحذوفين ‿ لطرد الحسابات المحذوفه
🔗￤رابط الحذف ‿ لحذف حساب تلكرام
🎨￤زخرفه ‿ لزخرفه اي شي تريد
─ ─ ─ ─ ─ ─ ─ ─ ─
ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
end
if MsgText[1]== 'اوامر التحشيش' then
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
local text =[[
─ ─ ─ ─ ─ ─ ─ ─ ─ 
🤪￤•⊱ آوآمر التحشيش⊰•
...
─ ─ ─ ─ ─ ─ ─ ─ ─
👥￤تفعيل ‿ تعطيل  •⊱ الرفــع ⊰•
🗣￤تفعيل ‿ تعطيل  •⊱ الردود ⊰•
🕹￤تفعيل ‿ تعطيل  •⊱الالعـاب⊰•
📢￤تفعيل ‿ تعطيل  •⊱ التحذير ⊰•
👋￤تفعيل ‿ تعطيل  •⊱ الترحيب ⊰•
🆔￤تفعيل ‿ تعطيل  •⊱ الايدي ⊰•
🌅￤تفعيل ‿ تعطيل  •⊱ الايدي بالصوره ⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─ 
👨‍💻║ آوآمر •⊱ اوامر الوضع للمجموعه ⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
🔗￤ضع رابـط ‿ لوضع •⊱ رابط ⊰•
💳￤ضع اســـم ‿ لوضع •⊱ اســم ⊰•
🏞￤ضع صوره ‿ لوضع •⊱ صوره ⊰•
📡￤ضع وصـف ‿ لوضع •⊱ وصف ⊰• 
🧾￤ضع القوانيــن ‿ لوضع •⊱ القوانين ⊰• 
👋￤ضع الترحيب ‿ لوضع •⊱ ترحيــب ⊰•
💫￤ضع تكرار + العدد ‿ لوضع •⊱ تكرار ⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
👨‍💻║ •⊱اوامـر المطـور⊰• 
─ ─ ─ ─ ─ ─ ─ ─ ─
📛￤تفعيـل ‿ •⊱لتفعيل البوت ⊰•
🚫￤تعطيل ‿ •⊱لتعطيل البوت ⊰•
⚠️￤اسم بوتك + غادر ‿ •⊱لطرد البوت⊰•
👁‍🗨￤رفع منشى ‿ •⊱رفع منشى بالبوت⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
🔊￤اذاعه ‿ •⊱لنشر رساله لكل المجموعات⊰•
📢￤اذاعه خاص ‿ •⊱ لنشر رساله لكل المشتركين خاص⊰•
📣￤اذاعه عام ‿ •⊱لنشر رساله لكل المجموعات والخاص⊰•
🔈￤اذاعه عام بالتوجيه ‿ •⊱لنشر منشور قناتك بابتوجيه للكل⊰•
🀄️￤تنظيف المجموعات‿  •⊱لمسح المجموعات الوهميه⊰•
⚙￤تنظيف المشتركين ‿ •⊱لمسح المشتركين الوهميين⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
♻️￤تحديث ‿ •⊱لتحديث ملفات البوت⊰•
💭￤تحديث السورس ‿ •⊱لتحديث السورس الى اصدار احدث⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
👨‍💻║•⊱جميع اوامر الردود ⊰•
─ ─ ─ ─ ─ ─ ─ ─ ─
🔻￤الردود ‿ لعرض الردود المثبته
⚠️￤اضف رد ‿ لأضافه رد جديد
⚠️￤مسح رد ‿ الرد المراد مسحه
⚠️￤مسح الردود ‿ لمسح كل الردود
⚠️￤الردود العامه ‿ لمعرف الردود المثبته عام 
⚠️￤اضف رد عام ‿ لاضافه رد لكل المجموعات
⚠️￤مسح رد عام  ‿ لمسح الرد العام 
🔺￤مسح الردود العامه ‿ لمسح كل ردود العامه
─ ─ ─ ─ ─ ─ ─ ─ ─
ݪݪـﻤزيد م̷ـــن آݪمعـݪومـآت ݛآسݪنآ↭ ]]..SUDO_USER
sendMsg(msg.chat_id_,msg.id_,text)
return false
...
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
if not redis:get(snfor..'lave_me'..msg.chat_id_) then 
return "👨‍🎓*￤*أهلا عزيزي "..msg.TheRankCmd.."\n📡*￤* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(snfor..'lave_me'..msg.chat_id_) 
return "👨‍🎓*￤*أهلا عزيزي "..msg.TheRankCmd.."\n📡*￤* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "⚠️*￤*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🎭" end
if redis:get(snfor..'lave_me'..msg.chat_id_) then 
return "👨‍🎓*￤*أهلا عزيزي "..msg.TheRankCmd.."\n📡*￤* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(snfor..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
local SubDel = redis:del(snfor..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n🎭" end
local UserChaneel = redis:get(snfor..":UserNameChaneel")
if UserChaneel then
...
function tophoto(kara,snfor)   
if snfor.content_.ID == "MessageSticker" then        
local bd = snfor.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(snfor..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(snfor..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛￤* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(snfor..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(snfor..'users',msg.sender_user_id_)
if redis:get(snfor..'lock_service') then 
text = [[🤖￤آهلا انآ بــــوت آســمـي   []]..redis:get(snfor..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(snfor.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(snfor..'lock_twasel') then
...
redis:setex(snfor.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(snfor..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(snfor..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(snfor..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🚀 \n-')
elseif msg.photo then 
redis:hset(snfor..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه صوره للرد بنجاح ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(snfor..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه بصمه صوت للرد بنجاح ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(snfor..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه متحركه للرد بنجاح ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(snfor..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه فيديو للرد بنجاح ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(snfor..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه للصوت للرد بنجاح ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(snfor..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(snfor..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(snfor..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(snfor..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 ')
elseif msg.photo then 
redis:hset(snfor..'replay_photo:group:',klma,photo_id)
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه صوره للرد العام ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(snfor..'replay_voice:group:',klma,voice_id)
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه بصمه صوت للرد العام ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(snfor..'replay_animation:group:',klma,animation_id)
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه متحركه للرد العام ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(snfor..'replay_video:group:',klma,video_id)
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه فيديو للرد العام ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(snfor..'replay_audio:group:',klma,audio_id)
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂￤تم اضافه للصوت للرد العام ✓\n🗂￤يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(snfor..'replay_sticker:group:',klma,sticker_id)
redis:del(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(snfor..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(snfor..":ForceSub:"..msg.sender_user_id_)
...
redis:set(snfor..":UserNameChaneel",msg.text)
...
if redis:get(snfor..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(snfor..'namebot:witting'..msg.sender_user_id_)
redis:set(snfor..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭￤تم تغير اسم البوت  ✋🏿\n🗯￤الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(snfor..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(snfor..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(snfor..'replay_photo:group:',msg.text)
redis:hdel(snfor..'replay_voice:group:',msg.text)
redis:hdel(snfor..'replay_animation:group:',msg.text)
redis:hdel(snfor..'replay_audio:group:',msg.text)
redis:hdel(snfor..'replay_sticker:group:',msg.text)
redis:hdel(snfor..'replay_video:group:',msg.text)
redis:setex(snfor..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜￤جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛￤[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(snfor..'delrdall:'..msg.sender_user_id_) then
redis:del(snfor..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(snfor..'replay:all',msg.text)
local photo =redis:hget(snfor..'replay_photo:group:',msg.text)
local voice = redis:hget(snfor..'replay_voice:group:',msg.text)
local animation = redis:hget(snfor..'replay_animation:group:',msg.text)
local audio = redis:hget(snfor..'replay_audio:group:',msg.text)
local sticker = redis:hget(snfor..'replay_sticker:group:',msg.text)
local video = redis:hget(snfor..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*￤*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(snfor..'replay:all',msg.text)
redis:hdel(snfor..'replay_photo:group:',msg.text)
redis:hdel(snfor..'replay_voice:group:',msg.text)
redis:hdel(snfor..'replay_audio:group:',msg.text)
redis:hdel(snfor..'replay_animation:group:',msg.text)
...
if redis:get(snfor..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(snfor..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(snfor..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*￤* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(snfor..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(snfor..'welcom:witting'..msg.sender_user_id_) 
redis:set(snfor..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*￤* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(snfor..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(snfor..'rulse:witting'..msg.sender_user_id_) 
redis:set(snfor..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*￤* مرحبآ عزيزي\n📦￤تم حفظ القوانين بنجاح ✓\n🔖￤ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(snfor..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(snfor..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(snfor..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(snfor..'linkGroup'..msg.sender_user_id_,link) 
redis:set(snfor..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'🖇￤تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(snfor..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(snfor..'about:witting'..msg.sender_user_id_) 
...
if redis:get(snfor..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(snfor..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(snfor..'users')  
local groups = redis:smembers(snfor..'group:ids')
...
if redis:get(snfor..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(snfor..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(snfor..'users')
if #pv >= 300 then
...
if redis:get(snfor..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(snfor..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(snfor..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(snfor..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(snfor..':WELCOME_BOT'),[[⚜￤اهلا انآ بوت آسـمـي ]]..redis:get(snfor..':NameBot:')..[[ ✓
👨🏻‍✈️￤آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛￤مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if msg.forward_info and redis:get(snfor..'fwd:'..msg.sender_user_id_) then
redis:del(snfor..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(snfor..'users')
local groups = redis:smembers(snfor..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(snfor..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(snfor..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(snfor..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(snfor..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(snfor..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(snfor..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(snfor..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(snfor..'replay:'..msg.chat_id_,msg.text)
redis:hdel(snfor..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(snfor..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(snfor..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(snfor..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(snfor..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(snfor..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(snfor..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜￤جيد , يمكنك الان ارسال جواب الرد \n🔛￤[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(snfor..'delrd:'..msg.sender_user_id_) then
redis:del(snfor..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(snfor..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(snfor..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(snfor..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(snfor..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(snfor..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(snfor..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(snfor..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*￤*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(snfor..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(snfor..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(snfor..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(snfor..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(snfor..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(snfor..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(snfor..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(snfor..'welcome:msg'..msg.chat_id_) or "👨‍🎓￤اهلن بك عزيزي {الاسم}\n🎟￤معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜￤اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(snfor..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻￤مرحبأ عزيري القوانين كلاتي 👇🏻\n⚠️￤ممنوع نشر الروابط\n⚠️￤ممنوع التكلم او نشر صور اباحيه\n⚔￤ممنوع  اعاده توجيه\n💭￤ممنوع التكلم بلطائفه\n♥️￤الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(snfor..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(snfor..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(snfor..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(snfor..'welcome:get'..msg.chat_id_)
end
redis:setex(snfor..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(snfor..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(snfor..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(snfor..'num_msg_snfor'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(snfor..'sender:'..msg.sender_user_id_..':flood',30,true)
...
redis:setex(snfor..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(snfor..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(snfor..'lock_woring'..msg.chat_id_) and not redis:get(snfor..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(snfor..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(snfor..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(snfor..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*￤* لا يمكنني مسح الرساله المخالفه .\n🎟*￤* لست مشرف او ليس لدي صلاحيه  الحذف \n 🎭')    
end
if redis:get(snfor..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(snfor..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(snfor..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(snfor..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(snfor..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(snfor..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(snfor..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(snfor..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(snfor..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(snfor..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(snfor..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(snfor..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(snfor..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(snfor..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(snfor..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(snfor..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(snfor..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(snfor..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(snfor..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(snfor..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(snfor..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(snfor..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(snfor..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(snfor..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(snfor..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(snfor..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(snfor..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(snfor..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(snfor..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(snfor..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(snfor..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(snfor..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(snfor..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(snfor..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(snfor..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
if not redis:sismember(snfor..'kara','Start') then
redis:setex(snfor..'2DaySleep',172800,'uop90')
redis:sadd(snfor..'kara','Start')
end
if not redis:get(snfor..'2DaySleep') and redis:sismember(snfor..'kara','Start') and not redis:sismember(snfor..'kara','End') then
redis:setex(snfor..'4DaySleep',345600,'mohammad')
redis:sadd(snfor..'kara','End')
sendMsg(SUDO_ID,0,"👨‍💻↫ اهلا عزيزي المطورا")
end
if not redis:get(snfor..'4DaySleep') and not redis:sismember(snfor..'kara','End2') then
sendMsg(SUDO_ID,0,"👨‍🎓￤هلآو حبي ❤️")
redis:sadd(snfor..'kara','End2')
end
if not redis:get('kar') then
redis:setex('kar',86400,true) 
json_data = '{"BotID": '..snfor..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(snfor..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(snfor..'group:name'..GroupS) or '')
...
local admins = redis:smembers(snfor..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(snfor..'username:'..value)
if info then 
...
local creator = redis:smembers(snfor..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(snfor..'owners:'..GroupS)
if #owner ~= 0 then
...
if redis:get(snfor..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(snfor..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️￤انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧￤المجموعه : '..FlterName(redis:get(snfor..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️￤ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️￤انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️￤سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧￤او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(snfor..'ExpireDate:'..msg.chat_id_) / 86400)
