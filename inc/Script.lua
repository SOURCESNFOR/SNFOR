...
if (MsgText[1] == "رفع المدير"  or MsgText[1] == "رفع مدير" ) and ZainJoinChannel(msg) then
...
if (MsgText[1] == "تنزيل المدير" or MsgText[1] == "تنزيل مدير" ) and ZainJoinChannel(msg) then
if not msg.Creator then return "⚠️*￤*هذا الامر يخص {المطور,المنشئ} فقط  \n⚠️" end
if not MsgText[2] and msg.reply_id then
...
if (MsgText[1] == "رفع منشى اساسي" or MsgText[1] == "رفع منشئ اساسي") and ZainJoinChannel(msg) then
...
if (MsgText[1] == "تنزيل منشى اساسي" or MsgText[1] == "تنزيل منشى اساسي") and ZainJoinChannel(msg) then
if not msg.SudoUser then return "⚠️*￤*هذا الامر يخص {المطور,المطور الاساسي} فقط  \n⚠️" end
if not MsgText[2] and msg.reply_id then 
...
if (MsgText[1] == "رفع منشى" or MsgText[1] == "رفع منشئ") and ZainJoinChannel(msg) then
...
if (MsgText[1] == "تنزيل منشى" or MsgText[1] == "تنزيل منشئ" ) and ZainJoinChannel(msg) then
...
if MsgText[1] == "رفع مطور" and ZainJoinChannel(msg) then
if not msg.SudoBase then return "⚠️*￤*هذا الامر يخص {المطور الاساسي 👨‍💻} فقط  \n⚠️" end
if not MsgText[2] and msg.reply_id then 
...
if MsgText[1] == "تنزيل مطور" and ZainJoinChannel(msg) then
if not MsgText[2] and msg.reply_id then 
...
return '👨🏾‍🔧￤ اصدار سورس سنفـور : *v'..version..'* \n📡'
end
...
send_key(msg.sender_user_id_,'  [⚜￤قناة سورس : سنفـور](t.me/@SOURCESNFOR)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات ⚠️" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"⚠️*￤*هذا الامر يخص {المطور الاساسي} فقط  \n⚠️" end
...
if Text == 'time' or Text == 'الوقت' and ZainJoinChannel(msg) then
...
if Text == 'tophoto' or Text == 'صوره' and tonumber(msg.reply_to_message_id_) > 0 and ZainJoinChannel(msg) then
...
{"تعطيل البوت خدمي","تفعيل البوت خدمي","المطورين 🔥"},
 {"المشتركين Ⓜ","المجموعات 🌋","الاحصائيات ⚠️"},
...
local NUM_MSG_MAX = (redis:get(snfor..'num_msg_max'..msg.chat_id_) or 5)
